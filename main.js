const questions = [
  ...
  },
  {
    number: 11,
    type: "生成AIの問題性",
    sentence: "現在の主な生成AIは、利用することによって意図せず権利侵害してしまう可能性があることが問題があると思う",
    choice: ["とてもそう思う", "まあそう思う", "あまりそう思わない", "全くそう思わない", "その他", "分からない"],
    value:[2,1,-1,-2,0,0]
  },
  {
...
function tsugihe(){
  ...
  if(user.questionNumber < questions.length){
    ...
    resultSentence += "《pt及び%の計算方法》とてもそう思う:2pt,まあそう思う:1pt,あまりそう思わない:-1pt,全くそう思わない:-2pt,その他:0pt,分からない:0ptとして、合計で0ptのとき50%とする。項目ごとに出題数が異なるため、何ptで100%になるかは項目によって異なります。<br><br><br>";
